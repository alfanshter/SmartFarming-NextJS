...
export default function KontrolTandonPage() {
  ...
  const handleToggleAgitator = async (id: string, enabled: boolean) => {
    try {
      ...
      console.error("Failed to toggle agitator:", err);
    }
  };
            ...
            <div className="space-y-4">
              ...
              <div className="relative pt-1">
                <input
                  ...
                  step="1"
                  value={maxFillLevel}
                  onChange={(e) => handleMaxFillLevelChange(Number(e.target.value))}
              ...
              <div>
                ...
                <div className="relative pt-1">
                  <input
                    ...
                    step="5"
                    value={minLevel}
                    onChange={(e) => handleMinLevelChange(Number(e.target.value))}
          ...
          <div className="bg-white rounded-2xl shadow-md p-6">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="text-center">
                ...
                <p className="text-xl font-bold text-green-600">{waterStats?.today || 0}L</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-xl font-bold text-green-600">{waterStats?.thisWeek || 0}L</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-xl font-bold text-purple-600">{waterStats?.thisMonth || 0}L</p>
              </div>
            </div>
          </div>
        </div>
